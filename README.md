...
# 10/31/2024
Russell:<br> One idea to bring better the virustotal score is to have the user download a program called "decrypt-stub.ps1." Once the .ps1 file is made then we can encrypt it to base64 (using https://gchq.github.io/CyberChef/) and then convert that to an executable by using the software called "Win-PS2EXE". 
