...
Russell:
    ...
    reverse shell executable that has gone through our unique encrypt/decrypt process. Virus Total scored it 11/73 security vendors detecting this malware. Not to mention Microsoft does not detect this as malware. This is a great milestone for what we are trying to accomplish and expose. What is needed next: modify the stub to retrieve the raw shellcode a web server and then download it to dynamically 
