...
and figured this issue out ![two-fingers](10-30-ss.png). I call this the two-finger brute-force method. It wasnt skipping ' ' or semicolons. Even after fixing this, the executable would not function. But when I moved this executable to another folder it worked. This is very strange because I excluded microsoft defender 
